...
class CacheStore {
  ...
  Future<FileInfo> getFile(String key) async {
    final cacheObject = await retrieveCacheData(key);
  ...
  FileInfo getFileFromMemory(String key) {
    ...
    return FileInfo(file, FileSource.Cache, cacheObject.validTill, key);
  }
